document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('mousemove', function (e) {
        ...
        if (background) {
            ...
            background.style.background = `radial-gradient(circle at ${x * 100}% ${y * 100}%, ${colorStart}, ${colorEnd})`;
        }
    });
    ...
    favorites.forEach((button) => {
        button.addEventListener('click', () => {
            ...
            updateFavoritesInLocalStorage(ascensoId, button.classList.contains('active'));
        });
    });
    ...
    searchInput.addEventListener('input', function () {
        ...
        categories.forEach(category => {
            ...
            ascensos.forEach(ascenso => {
                ...
                if (name.includes(filter) || date.includes(filter) || categoryName.includes(filter)) {
